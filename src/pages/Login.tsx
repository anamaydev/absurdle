    ...
    <main className="min-h-dvh flex justify-center items-center relative">
      ...
      <section className="p-3 flex flex-col gap-6 border rounded-[28px] bg-black-900 border-grey-900">
        ...
        <div className="flex flex-col gap-2">
          ...
          <button className="p-2.5 group flex justify-center items-center gap-2.5 rounded-2xl cursor-pointer bg-grey-900 hover:bg-grey-50 transform transition-colors duration-300 ease-out">
            <GoogleIcon/>
